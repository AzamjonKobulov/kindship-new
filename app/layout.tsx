    ...
    <html lang="en" className={`${poppins.variable} h-full`}>
      <body className="font-sf-pro-text bg-brand-bg h-full">
        <main className="h-screen md:h-auto max-w-4xl xl:max-w-5xl mx-auto lg:flex items-start lg:space-x-10 xl:space-x-14 md:px-4 md:pt-14 pb-10">
          <Sidebar />
          <div className="relative flex-1 h-96 sm:h-auto overflow-auto sm:overflow-hidden bg-white md:border border-brand-gray-divider shadow-base-container md:rounded-xl  px-4 py-5 md:p-10">
            {children}
          </div>
        </main>
